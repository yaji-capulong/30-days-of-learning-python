...
print(varA, varA, varA,varA,varA)
newB = varB * varA
newB2 = newB * varB
newB3 = newB2 * newB
print(varB, varA, newB, newB2, newB3)
newC = varC * varA
newC2 = newC * varC
newC3 = newC2 * newC
print(varC, varA, newB, newC2, newC3)
newD = varD * varA
newD2 = newD * varD
newD3 = newD2 * newD
print(varD, varA, newD, newD2, newD3)
newE = varE * varA
newE2 = newE * varE
newE3 = newE2 * newE
print(varE, varA, newE, newE2, newE3)